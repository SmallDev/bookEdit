angular.module('bookEditApp').controller('editBookCtrl', ['$scope', 'bookService', '$routeParams', '$location', 'Upload', 'notificationService', function ($scope, bookService, $routeParams, $location, Upload, notificationService) {
